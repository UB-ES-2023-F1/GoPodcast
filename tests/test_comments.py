...
def test_get_comments(app, data):
    ...
    # Episode not found
    response = client.get(f"/episodes/00000000-0000-0000-0000-000000000000/comments")
    ...
    response = client.get(
        f"/episodes/{data['id_episode']}/comments/{data['id_comment1']}/replies"
    )
    assert response.status_code == 200
    expected_response = [
        {
    ...
    response = client.get(
        f"/episodes/{data['id_episode']}/comments/{data['id_comment2']}/replies"
    )
    assert response.status_code == 200
    expected_response = []
    assert response.get_json() == expected_response
    ...
    # Episode not found
    response = client.get(
        f"/episodes/00000000-0000-0000-0000-000000000000/comments/{data['id_comment2']}/replies"
    )
    assert response.status_code == 404

    # Comment not found
    response = client.get(
        f"/episodes/{data['id_episode']}/comments/00000000-0000-0000-0000-000000000000/replies"
    )
    assert response.status_code == 404
